...
to setup
  ...
  ask patches [
    ...
    set pcolor scale-color blue value 0 1
  ]
  create-turtles 1 [ set chooser dc:epsilon-greedy-chooser patches ]
...
to print-chooser-info
  ...
  print word "Options:             " dc:options chooser
  ...
  print word "Value of best patch: " dc:value chooser patch max-pxcor max-pycor
end
